...
class anix(IStrategy):
    ...
    buy_params = {
        "bbdelta_close": 0.0194,
        "bbdelta_tail": 0.8078,
        "close_bblower": 0.002,
        "closedelta_close": 0.0069,
        "leverage_num": 10,
        "rocr_1h": 0.6589,
    }
    ...
    sell_params = {
        ...
        "pSL_1": 0.083,
        "pSL_2": 0.167,
        "sell_bbmiddle_close": 1.1,  # value loaded from strategy
        "sell_fisher": 0.5,  # value loaded from strategy
    }
